...
// go run -race "filename"  --> this will resolve the race conditions and give the output
// If in this code if we done include .lock() race condition occurs and we get inconsistent values in each run.
